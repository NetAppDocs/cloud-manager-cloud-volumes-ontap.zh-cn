...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_gcp_9101.html["GCP 中支持的 Cloud Volumes ONTAP 配置"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_gcp_9101.html["GCP 中 Cloud Volumes ONTAP 的存储限制"^]
