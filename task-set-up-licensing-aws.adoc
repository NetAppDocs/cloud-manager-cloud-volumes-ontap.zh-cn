...
创建Cloud Volumes ONTAP 工作环境时、Cloud Manager会提示您订阅AWS Marketplace中提供的协议。然后、该订阅将与工作环境关联以进行收费。您可以对其他工作环境使用相同的订阅。
...
TIP: 您可以从"设置">"凭据"页面管理与AWS帐户关联的AWS Marketplace订阅。 https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-aws-accounts.html["了解如何管理AWS帐户和订阅"^]
...
与每小时订阅类似、Cloud Manager会提示您订阅AWS Marketplace中提供的年度合同。
