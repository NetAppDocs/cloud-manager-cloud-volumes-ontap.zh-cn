...
此页面上介绍的增强功能专用于支持 Cloud Volumes ONTAP 管理的 Cloud Manager 功能。 https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/index.html["查看《 Cloud Volumes ONTAP 发行说明》"^] 了解 Cloud Volumes ONTAP 软件本身的新增功能。
...
现在，首发特惠价已过期，您将需要为使用 WORM 存储付费。根据卷的总配置容量，每小时充电一次。此适用场景 新的和现有的 Cloud Volumes ONTAP 系统。
...
link:concept-netapp-accounts.html["了解有关 NetApp 客户的更多信息"]。



== 2022 年 1 月 2 日（连接器 3.9.14 ）
...
+
下面是在 Azure 中部署新 Cloud Volumes ONTAP 系统时可以选择的充电方法示例：
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes["查看 AWS 中支持的 Cloud Volumes ONTAP 配置"^]。
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes["在 GCP 中查看支持的 Cloud Volumes ONTAP 配置"^]。



== 2021 年 5 月 30 日（连接器 3.3.7 ）
