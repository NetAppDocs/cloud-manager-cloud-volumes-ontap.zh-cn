...
TIP: 如果您正在使用的 Azure 帐户具有 https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-permissions-azure.html["所需权限"^]，在部署失败或删除时， Cloud Manager 会从资源组中删除 Cloud Volumes ONTAP 资源。
