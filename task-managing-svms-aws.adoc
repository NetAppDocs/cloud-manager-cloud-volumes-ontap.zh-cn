...
从 9.7 版开始， AWS 中具有附加许可证的 Cloud Volumes ONTAP BYOL 支持多个 Storage VM 。转至 https://docs.netapp.com/us-en/cloud-volumes-ontap/index.html["《 Cloud Volumes ONTAP 发行说明》"^] 验证您的 Cloud Volumes ONTAP 版本支持的 Storage VM 数量。
...
.步骤
. 转到 https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_aws_9101.html["《 Cloud Volumes ONTAP 发行说明》中的 " 存储限制 " 部分"^]。
